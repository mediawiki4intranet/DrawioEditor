...
$wgHooks['ResourceLoaderGetConfigVars'][] = 'DrawioEditor::onGetConfigVars';
...
class DrawioEditor {
    ...
    public static function onGetConfigVars(&$vars) {
        global $wgDrawioEditorServiceUrl;
        $vars['wgDrawioEditorServiceUrl'] = $wgDrawioEditorServiceUrl;
        return true;
    }
